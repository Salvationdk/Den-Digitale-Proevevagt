...
namespace DpvClassLibrary.Workers
{
	public abstract class DataPackageEnvelopeWorkerBase : WorkerBase, IDisposable
	{
		...
		private static List<DataPackageEnvelope.ActiveColsEnum> _activeCols = new List<DataPackageEnvelope.ActiveColsEnum>();
		...
		protected abstract DataPackageEnvelope.ActiveColsEnum ActiveColType
		{
			get;
		}

		public static IEnumerable<DataPackageEnvelope.ActiveColsEnum> GetActiveCols()
		{
			foreach (DataPackageEnvelope.ActiveColsEnum activeCol in _activeCols)
			{
				yield return activeCol;
			}
		}

		protected static void AddActiveCol(DataPackageEnvelope.ActiveColsEnum activeColToAdd)
		{
