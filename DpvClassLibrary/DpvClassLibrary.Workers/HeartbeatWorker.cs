...
namespace DpvClassLibrary.Workers
{
	...
	{
		protected override DataPackageEnvelope.ActiveColsEnum ActiveColType => (DataPackageEnvelope.ActiveColsEnum)1;
		...
		protected override List<DataPackage> GetDataPackages()
		{
			...
			list.Add(new DataPackage((DataPackage.ColTypeEnum)1, (bool?)false, new byte[0], (DateTime?)DataPackageEnvelopeAwsReceiver.ServerTime, (long?)GetAndIncrementWorkSequence()));
			return list;
		}
